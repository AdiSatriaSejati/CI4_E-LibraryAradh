    ...
    <form action="<?= base_url('admin/members'); ?>" method="post">
      ...
      <div class="row mt-3">
        <div class="col-12 col-md-6 mb-3">
          ...
          <input type="text" class="form-control <?php if ($validation->hasError('first_name')) : ?>is-invalid<?php endif ?>" id="first_name" name="first_name" value="<?= $oldInput['first_name'] ?? ''; ?>" placeholder="Adi Satria Sejati" required>
      ...
      <div class="row">
        <div class="col-12 col-md-6 mb-3">
          ...
          <input type="email" class="form-control <?php if ($validation->hasError('email')) : ?>is-invalid<?php endif ?>" id="email" name="email" value="<?= $oldInput['email'] ?? ''; ?>" placeholder="12221455@bsi.ac.id" required>
          <div class="invalid-feedback">
        ...
        <div class="col-12 col-md-6 mb-3">
          ...
          <input type="tel" class="form-control <?php if ($validation->hasError('phone')) : ?>is-invalid<?php endif ?>" id="phone" name="phone" value="<?= $oldInput['phone'] ?? ''; ?>" placeholder="+6282136177589" required>
          <div class="invalid-feedback">
